...
namespace Tnt.KofaxCapture.TntCiReportingExport
{
    ...
    internal static class Utility
    {
        ...
        {
            var filePath = GetAssociatedFilePath("TntCiReportingExport.inf");
            var settingsValue = new StringBuilder(10);
            var result = NativeMethods.GetPrivateProfileString("TntCiReportingExport", "OpenCloseLoggingEnabled",
