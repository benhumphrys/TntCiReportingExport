...
namespace Tnt.KofaxCapture.A6.TntExportPacsRelUnitTests
{
    ...
    public class KfxReleaseScriptUnitTest
    {
        ...
        public void TestValidConsignmentRelease()
        {
            ...
            bytes = File.ReadAllBytes(@"KfxReleaseScriptUnitTestResources\BatchControl_B15012016101444_BUD_09.xml");
            ...
            var pathsAndHashes = new[]
            {
                ...
                new
                {
                    FilePath = @"A6Output\BatchControl_B15012016101444_BUD_09.xml",
                    Hash = batchHash
                },
                new
                {
                ...
                new
                {
                    FilePath = @"A6Output\BatchMarker_B15012016101444_BUD_09.mkr",
                    Hash = "D41D8CD98F00B204E9800998ECF8427E"
                },
                new
                {
